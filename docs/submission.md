...
- Name: Java Backend Skills
- Description: Independent skills for idiomatic Java and Spring backend development.
- Source: https://github.com/Dankosik/java-backend-skills
- Publisher used by this open-source package: Dankosik
- Support: https://github.com/Dankosik/java-backend-skills/issues
- Privacy: https://github.com/Dankosik/java-backend-skills/blob/main/PRIVACY.md
...
Prompt: "Use java-implement. Write a Java function clamp(value, minimum, maximum).
...
Prompt: "Use java-unit-testing. Test a cache lookup whose contract is: now < expiresAt
...
Prompt: "Use java-idiomatic. Review a proposed optimization that sorts the caller's
...
the smallest compatible approach for Java."
...
Prompt: "Use java-performance. This command or operation feels slow on large inputs,
...
Prompt: "Use java-design. A wrapper forwards every method to one collaborator with
...
Expected: ordinary assistance without imposing Java development skills,
...
Prompt: "Use java-implement. For exactly the same input 0 and the same context, function
